...
- [TASK-0007 — De-vendor the four uniform downstream projects](../../../tasks/TASK-0007-devendor-four-uniform-projects.md)
- [TASK-0008 — De-vendor `orchestrator-dashboard`](../../../tasks/TASK-0008-devendor-orchestrator-dashboard.md)

Only TASK-0001 through TASK-0004 land in this repository and therefore in this Epic's pull request. TASK-0005 and TASK-0006 commit into `dotfiles-claude`; TASK-0007 and TASK-0008 commit into five downstream project repositories.
...
- No project under `~/dev` MUST hold a vendored orchestrator directory, and each formerly-vendored project MUST name the external engine.
