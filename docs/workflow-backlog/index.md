...
- **Ein File pro Item.** Format `topics/<NNN>-<slug>.md`. IDs stabil ab Vergabe (kein Renumbering bei Prio-Wechsel oder Löschung). Slug in kebab-case und trägt das Topic-Keyword für Grep.
...
|-----|------|---------------------------------------------------------------|--------|------------------------------------------------------|
| 002 | P1   | Root Cause + Fix bleiben nach Bugfix leer                     | open   | [→](topics/002-root-cause-fix-empty.md)              |
| 003 | P1   | Regression-Szenarien werden nicht in Epic-Test-Docs angehängt | open   | [→](topics/003-regression-scenarios-not-appended.md) |
| 004 | P1   | `workflow-implementation` Skill kennt keine Bugs              | open   | [→](topics/004-workflow-implementation-task-only.md) |
| 005 | P1   | Manuelle `fix:`-Commits umgehen Orchestrator-Bug-Flow         | open   | [→](topics/005-manual-fix-bypasses-orchestrator.md)  |
| 006 | P2   | Task-Implementation ohne expliziten Planning-Step             | open   | [→](topics/006-task-planning-step.md)                |
| 007 | P2   | Test-Infra-Bugs vs. Code-Bugs unterscheiden                   | open   | [→](topics/007-test-infra-vs-code-bugs.md)           |
| 008 | P2   | `MAX_CONSECUTIVE_ABORTS` Cascade Guard                        | open   | [→](topics/008-max-consecutive-aborts-guard.md)      |
| 009 | P2   | Dirty Working Tree nach Abort                                 | open   | [→](topics/009-dirty-tree-after-abort.md)            |
| 010 | P2   | Structured-Smoke-Konzept                                      | open   | [→](topics/010-structured-smoke.md)                  |
| 011 | P2   | Logging prosa-vermischt, retrospektiv schwer auswertbar       | open   | [→](topics/011-logging-prose-mixed.md)               |
| 012 | P2   | `/ship-epic` PR-Ceremony togglable per Projekt                | open   | [→](topics/012-ship-epic-togglable.md)               |
| 013 | P2   | `docs/tasks/` Layout nicht final                              | open   | [→](topics/013-docs-tasks-layout.md)                 |
| 014 | P3   | Dashboard zeigt Type-Spalte nicht                             | open   | [→](topics/014-dashboard-type-column.md)             |
| 015 | P3   | `MultiEdit`-Deny cosmetic Warning                             | open   | [→](topics/015-multiedit-deny-warning.md)            |
| 016 | P3   | feat/fix-Unterscheidung in Orchestrator-Commits               | open   | [→](topics/016-feat-fix-orchestrator-commits.md)     |
...
| ID  | Prio | Titel                                                         | Status | File                                                 |
|-----|------|---------------------------------------------------------------|--------|------------------------------------------------------|
| 001 | P1   | Backlog-Struktur-Pass (Ordner + Index + Konventionen)         | done   | [→](topics/001-backlog-structure-pass.md)            |
| 020 | —    | `workflow-bugs` Skill                                         | done   | [→](topics/020-workflow-bugs-skill.md)               |
| 019 | —    | Merged work-item index (`docs/tasks/`)                        | done   | [→](topics/019-merged-work-item-index.md)            |
| 018 | —    | Bug-flow Orchestrator variant                                 | done   | [→](topics/018-bug-flow-orchestrator-variant.md)     |
| 017 | —    | Entry-point-anchor test rule (`workflow-tests`)               | done   | [→](topics/017-entry-point-anchor-test-rule.md)      |
