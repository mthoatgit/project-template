...
- **Cross-References.** Backlog ist SoT für offene Diskussionen. `docs/tasks/index.md` ist für akzeptierte Arbeit mit T/B-File — Graduation-Trigger: „das bauen wir jetzt" → T/B-File anlegen → Backlog-Item Status auf `done` mit Resolution-Link → move nach `archive/`.
