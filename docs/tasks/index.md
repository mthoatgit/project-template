...
|-----------|----------------------------|------|--------------------------------------------------------------------------|---------------|
| TASK-0001 | E1-orchestrator-extraction | task | Remove the vendored orchestrator from the scaffold                       | pending       |
| TASK-0002 | E1-orchestrator-extraction | task | State the execution engine in the scaffolded project's CLAUDE.md         | pending       |
| TASK-0003 | E1-orchestrator-extraction | task | Remove project-template's own orchestrator artefacts                     | pending       |
